...
//Eink Mini epaper Board -> ESP32 auf S3 Basic Board
...
void Display_Start(void){
  ...
  gfx.drawRoundRect(20, 0, 50, 50, 3, GxEPD_WHITE);
  ...
  gfx.setCursor(10, 220); gfx.setFont(Schrift2);
  gfx.print("Small Board");
  gfx.setCursor(155, 95); gfx.setFont(Schrift2);   
  gfx.print(zahlen);
  zahlen++;  
  gfx.display(true);
  gfx.drawRoundRect(70, 0, 50, 50, 3, GxEPD_WHITE);
  gfx.display(true);
  gfx.drawRoundRect(70, 50, 50, 50, 3, GxEPD_WHITE);
  gfx.display(true);
  gfx.drawRoundRect(20, 50, 50, 50, 3, GxEPD_WHITE);
  gfx.display(true);
